...
import { BlockLetterAPI, CheckBlockedAPI, CreateLetterAPI, DeleteLetterAPI, GetLettersAPI, GetRepliesAPI, UnblockLetterAPI } from 'src/common/swagger/decorator/letter-api.decorator';
